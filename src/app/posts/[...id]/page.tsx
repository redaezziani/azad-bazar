...
const page = () => {
  return (
   <div className='mx-5 md:m-10 flex flex-col justify-center  gap-10 '>
     <div className='  flex flex-col md:flex-row justify-center items-start gap-6' >

<div className=' flex flex-col     justify-start items-start gap-3 '>
  <div className='w-full  '>
    <img
      className=" w-full md:w-[500px] aspect-video object-cover rounded-md"
  ...
  <h3 className='text-lg font-semibold text-zinc-900 capitalize'>
    a beautiful hotel room in the heart of maldive island
  </h3>
  ...
  <div className='flex flex-col gap-3 justify-start items-start'>
    ...
    >
      get the best of the best with this amazing hotel room in the heart <br /> of maldive island , with a beautiful view of the ocean and the beach <br /> Lorem ipsum, dolor sit amet consectetur adipisicing elit. <br /> Praesentium minus asperiores commodi doloribus corrupti quis <br />

      and the beach Lorem ipsum, dolor sit amet consectetur adipisicing elit. <br /> Praesentium minus asperiores commodi doloribus corrupti quis <br /> aliquid provident,
      maiores libero ullam laborum dolorum ipsum  <br />  nostrum magni? Cumque voluptas  unde ipsum maxime?
    </p>
  </div>
</div>
...
<div className='flex flex-col gap-10  w-full md:w-[500px]  '>
  <div className=' bg-slate-100   flex flex-col gap-10  w-full md:w-[500px]  rounded-md px-3 py-4' >
    ...
    <button
      className='w-full flex justify-center items-center gap-2 bg-primary text-white py-2 rounded-md'
    ><svg xmlns="http://www.w3.org/2000/svg" className='text-white' viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
  ...
  <div className='bg-slate-100   flex flex-col  gap-5  w-full md:w-[500px]  rounded-md px-3 py-4 '>
